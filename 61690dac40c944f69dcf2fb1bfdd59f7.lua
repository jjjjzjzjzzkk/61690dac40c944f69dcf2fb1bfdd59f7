...
if BF then
	...
	local MyNameIs = LocalPlayer.DisplayName
	...
	function library:Window(name,game)
		if getgenv().Theme ~= nil then
			...
			ColorII = Color3.fromRGB(255, 255, 255)
	
			ColorIII = Color3.fromRGB(255, 255, 255)
			ColorIIII = Color3.fromRGB(0, 0, 0)
	
			ColorIIIII = Color3.fromRGB(255, 255, 255)
			ColorIIIIII = Color3.fromRGB(255, 255, 255)
	
			ColorIIIIIII = Color3.fromRGB(255, 255, 255)
			ColorIIIIIIII = Color3.fromRGB(255, 255, 255)
		end
		...
		TabSet.PlaceholderColor3 = Color3.fromRGB(255, 255, 255)
		...
		function Tabs:Tab(text,Real)
			...
			SectionBorder.ImageColor3 = Color3.fromRGB(255, 255, 255)
		...
		if FastTween then
			...
			if ThreeWorld then
				...
				elseif MyLevel >= 2275 then 
					...
					NameMon = "Head Baker"
					CFrameQuest = CFrame.new(-1928.31763, 37.7296638, -12840.626)
					CFrameMon = CFrame.new(-2288.793980758045, 106.9419174194336, -12811.111328125)
				end
			end
		else
			if OldWorld then
	...
	function SlowtoTarget(CFgo)
		...
		local info = TweenInfo.new((game:GetService("Players")["LocalPlayer"].Character.HumanoidRootPart.Position - CFgo.Position).Magnitude/365, Enum.EasingStyle.Linear)
	...
	function MytoTarget(CFgo)
		local tweenfunc = {}
		if (game:GetService("Players")["LocalPlayer"].Character.HumanoidRootPart.Position - CFgo.Position).Magnitude <= 365 then
			pcall(function()
				tween:Cancel()
	...
	local Main = library:Window("DaHub","Blox Fruit 2.12v")
	...
	-- Auto Electric clow
	AutoFarmTab:Toggle("Auto Electric Claw", getgenv().Setting["Auto Electric Claw"],function(vu)
		Electricclaw = vu
		if vu then
			local args = {
				[1] = "BuyElectro"
	...
	spawn(function()
		while wait(.25) do
			...
			if Electricclaw and game.Players.LocalPlayer:FindFirstChild("WeaponAssetCache") then
	...
	AutoFarmMiscTab:Toggle("Auto Buddy Swords",_G.AutoBuddySwords,function(v)
		if not ThreeWorld then
			library:Notification("Notification","Use In Thire World","Okay")    
		else
			AutoBuddySwords = v
		end 
	end)
	...
	Devil_Fruit_Sniper_Tab:Toggle("Tween To Fruit",false,function(value)
		for i,v in pairs(game:GetService("Workspace"):GetChildren()) do 
						if v.Name:find("Fruit") then
							if game:GetService("Workspace"):FindFirstChild(v.Name) then
					toTarget(v.Handle.Position,v.Handle.CFrame * CFrame.new(0,30,0))
				end
						end
											end
